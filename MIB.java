...
public class MIB extends JFrame implements ActionListener{
...
l2=new JLabel("Name");
l3=new JLabel("MIB");
l4=new JLabel("Director");
l5=new JLabel("Barry Sonnenfield");
l6=new JLabel("Release Year");
l7=new JLabel("2019");
l8=new JLabel("Price");
l9=new JLabel("Rs 120");
l10=new JLabel();
