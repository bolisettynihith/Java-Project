...
public class Order extends JFrame implements ActionListener{
	...
	public void addAll() {
		ImageIcon ii=new ImageIcon("/home/bolisettynihith/Documents/java_project/OopMaster/select.png");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==b1) {
			...
			try {
				FileWriter file=new FileWriter("/home/bolisettynihith/Documents/java_project/OopMaster/products.txt");
				file.write("");
				file.close();
			}
			catch(Exception f) {
